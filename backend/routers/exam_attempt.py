...
from services.exam_attempt import start_exam, get_question_list, submit_exam, fetch_exam_pdf, SubmittedAnswer
...
def submit(attempt_id: str, answers: List[SubmittedAnswer], user_info: tuple = Depends(get_current_user)):
    username, _ = user_info
